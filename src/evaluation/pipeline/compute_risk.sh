#!/bin/bash
#SBATCH --job-name=compute_risk
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --time=1-00:00:00
#SBATCH --output=/gpfs/commons/groups/gursoy_lab/fpollet/Git/clinical-exposure-metric/src/jobs/logs/compute_risk_%j.out
#SBATCH --error=/gpfs/commons/groups/gursoy_lab/fpollet/Git/clinical-exposure-metric/src/jobs/logs/compute_risk_%j.err
...
python src/evaluation/pipeline/compute_risk.py
